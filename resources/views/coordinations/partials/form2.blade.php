...
<div class="form-group">
    <div class="col-sm-4">
        ...
        {{ Form::select('id_farm', $farms, $coordination->id_farm, ['class' => 'form-control select-farm', 'placeholder' => 'Seleccione finca', 'style' => 'width: 200px']) }}
    </div>
    <div class="col-sm-4">
        {{ Form::label('id_client', 'Cliente', ['class' => 'control-label']) }}
        {{ Form::select('id_client', $clients, $coordination->id_client, ['class' => 'form-control select-client', 'placeholder' => 'Seleccione cliente']) }}
    </div>
    <div class="col-sm-4">
        {{ Form::label('description', 'Descripción', ['class' => 'control-label']) }}
        {{ Form::select('description', $products, $coordination->description, ['class' => 'form-control select-product', 'placeholder' => 'Seleccione tipo']) }}
    </div>
</div>
<div class="form-group">
